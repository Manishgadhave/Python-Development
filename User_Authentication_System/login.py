...
def forget_pass():
    def change_password():
        if user_entry.get()=="" or newpass_entry.get()=="" or confirmpass_entry.get()=="":
            ...
            con=pymysql.connect(host="localhost", user="root", password="9119", database="userdata")
            mycursor=con.cursor()
    ...
    confrimmpassLabel = Label(window, text="Confirm Password", font=("arial", 12, "bold"),
                      bg="white", fg="orchid1")
    confrimmpassLabel.place(x=470, y=290)
...
usernameEntry=Entry(root, width=25,  font=("Microsoft Yahei UI Light", 11, "bold"), bd=0, fg="firebrick")
...
passwordEntry=Entry(root, width=25,  font=("Microsoft Yahei UI Light", 11, "bold"), bd=0, fg="firebrick")
...
forgetButton=Button(root, text="Forget Password?", bd=0, bg="white", activebackground="white"
                 , cursor="hand2", font=("Microsoft Yahei UI Light", 9, "bold"), fg="firebrick", activeforeground="firebrick", command=forget_pass)
forgetButton.place(x=715, y=295)

loginButton=Button(root, text="Login", font=("Microsoft Yahei UI Light", 16, "bold")
                   , fg="white", bg="firebrick", activeforeground="white", activebackground="firebrick", cursor="hand2", bd=0, width=19, command=login_user)
loginButton.place(x=578, y=350)

orLabel=Label(root, text="--------------OR--------------", font=("Microsoft Yahei UI Light", 11, "bold"), fg="firebrick", bg="white")
orLabel.place(x=592, y=400)
...
signupLabel=Label(root, text="Dont have an account?", font=("Open Sans", 9, "bold"), fg="firebrick", bg="white")
signupLabel.place(x=590, y=500)

newaccountButton=Button(root, text="Register", font=("Open Sans", 9, "bold underline")
                   , fg="blue", bg="white", activeforeground="blue", activebackground="white", cursor="hand2", bd=0, command=signup_page)
newaccountButton.place(x=740, y=499)
